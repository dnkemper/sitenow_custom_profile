...
/**
 * @file
 * Theme implementation for a group of accordion items.
 *
 * Available variables:
...
<div class="panel-group" id="ovpred-accordion-group-id-<?php print $id; ?>" role="tablist" aria-multiselectable="true">
  <?php
    print $content;
  ?>
</div>
